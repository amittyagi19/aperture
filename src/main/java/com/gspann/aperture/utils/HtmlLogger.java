...

{
	...
	public void createHtmlLogFile() throws IOException {
		...
		String imagePath = System.getProperty("user.dir")+ "\\src\\test\\resources\\staticdata\\SephoraMSL.png";
		System.out.println("Image path is "+imagePath);

		BufferedReader br = new BufferedReader(new FileReader("logs/MSL-info.log"));
		try {
			StringBuilder sb = new StringBuilder();
			String line = br.readLine();
			String htmlheader = "<html><head>";
			htmlheader += "<title>Execution Log - sephoraMSL</title>";
			...
			String htmlfooter = "<p>Created by Vinay Malik\n GSPANN Technologies Inc.</body></html>";
