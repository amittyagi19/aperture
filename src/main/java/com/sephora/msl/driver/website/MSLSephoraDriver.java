package com.sephora.msl.driver.website;
...
import com.sephora.msl.utils.CommonUtils;
import com.sephora.msl.utils.NewExcelReader;
...
public class MSLSephoraDriver implements WebDriver {
	...
	public MSLSephoraDriver(PropertyFile property) {
		this.propertyFile = property;
		propertyFile.loadProps(defaultProps);
	}
	private static final Logger logger = LogManager.getLogger(MSLSephoraDriver.class.getName());
